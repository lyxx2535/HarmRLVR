...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=../ckpts/Qwen2.5-7B-Instruct \
    ...
    trainer.rollout_data_dir=logs/qwen2.5/air64/rollout \
    trainer.validation_data_dir=logs/qwen2.5/air64/val
